...
public class LoginPanel extends Window implements EventListener
{
    ...
    private void init()
    {
    	...
    	div = new Div();
    	div.setSclass(ITheme.LOGIN_BOX_VERSION_CLASS);
		Label txtVersion = new Label("Version:" + Adempiere.MAIN_VERSION);
    	txtVersion.setSclass(ITheme.LOGIN_BOX_VERSION_TXT_CLASS);
    	div.appendChild(txtVersion);
    	this.appendChild(div);
